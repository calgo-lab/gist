...
def main():
    ...
    cfg = yaml.safe_load((ROOT / "configs" / "baselines" / "kriging.yaml").read_text(encoding="utf-8")) or {}
    tft_cfg = yaml.safe_load((ROOT / "configs" / "baselines" / "tft.yaml").read_text(encoding="utf-8")) or {}
    ...
    figures_dir = ROOT / "reports" / "kriging" / "figures"
