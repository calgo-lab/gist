...
1. Clean Repo: DONE
2. Try out until March 1st: Create a strong (or as strong as possible) GRU separate baseline, then implement a differentiable spatial head and combine both in one joint-training pipeline
